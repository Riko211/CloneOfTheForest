...
namespace Building
{
    public class Floor : MonoBehaviour, IConstruction
    {
        [SerializeField]
        ...
        public void Construct()
        {
            ...
            {
                Collider[] targets = Physics.OverlapSphere(_priorityPoint.transform.position, 0.3f, _floorLayer);
        ...
        public void MoveBlueprint()
        {
            ...
            Collider[] targets = Physics.OverlapCapsule(_mainCamera.transform.position, checkPoint, 3f, _floorLayer);
