...
namespace Building
{
    public class Roof : MonoBehaviour, IConstruction
    {
        [SerializeField]
        ...
        public void Construct()
        {
            ...
            {
                Collider[] targets = Physics.OverlapSphere(_priorityPoint.transform.position, 0.3f, _roofLayer);
        ...
        public void MoveBlueprint()
        {
            ...
            Collider[] targets = Physics.OverlapCapsule(_mainCamera.transform.position, checkPoint, 3f, _roofLayer);
